...
@BotCommand
public final class HugCommand extends Command implements Arguments {
    public HugCommand() {
        super("hug", "Hug another user.");
    }
    ...
    public void execute(Interaction interaction) {
        ...
        var hugImage = Sushi.getRandom().getAnimeImage("hug");
        // Create an embed.
    ...
    @Override public Collection<Argument> getArguments() {
        return List.of(
            Argument.create("user", "The user to hug.", "user", OptionType.USER, true, 0)
        );
    }
}