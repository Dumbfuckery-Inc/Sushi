...
@BotCommand
public final class KissCommand extends Command implements Arguments {
    public KissCommand() {
        super("kiss", "Kiss another user.");
    }
    ...
    @Override public Collection<Argument> getArguments() {
        return List.of(
            Argument.create("user", "The user to kiss.", "user", OptionType.USER, true, 0)
        );
    }
}